...
class AutoModerationRuleUpdateEvent {
    on(old, notOld) {
        BaseApp.Events.getEventEmitter().emit(BaseApp.Events.DiscordEvents.AUTO_MODERATION_RULE_UPDATE, old, notOld);
    }
}
__decorate([
    ClientEvents.bind(BaseApp.Events.DiscordEvents.AUTO_MODERATION_RULE_UPDATE)
], AutoModerationRuleUpdateEvent.prototype, "on", null);
