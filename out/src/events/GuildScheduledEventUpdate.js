...
class GuildScheduledEventUpdateEvent {
    on(old, notOld) {
        BaseApp.Events.getEventEmitter().emit(BaseApp.Events.DiscordEvents.GUILD_SCHEDULED_EVENT_UPDATE, old, notOld);
    }
}
__decorate([
    ClientEvents.bind(BaseApp.Events.DiscordEvents.GUILD_SCHEDULED_EVENT_UPDATE)
], GuildScheduledEventUpdateEvent.prototype, "on", null);
